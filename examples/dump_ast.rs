...
fn dump(lang_name: &str, ts_lang: tree_sitter::Language, source: &str, depth: usize) {
...
fn main() {
    ...
    dump("Zig", tree_sitter_zig::LANGUAGE.into(), r#"
...
"#.trim(), 4);
    ...
    // Bash: function + alias
    dump("Bash", tree_sitter_bash::LANGUAGE.into(), r#"
#!/bin/bash
hello() { echo hi; }
...
"#.trim(), 4);
    ...
    dump("Markdown", tree_sitter_md::LANGUAGE.into(), r#"
# Title
