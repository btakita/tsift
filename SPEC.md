...
| [specs/local-kg-model.md](specs/local-kg-model.md) | Local Model Knowledge Graph Support (runtime/provider contracts, RTX 5090 model ranking, structured extraction schema, run manifests, provenance, multi-run semantics) |
...
| [specs/structural-patterns.md](specs/structural-patterns.md) | Structural Patterns (ast-grep): Structural Search, Structural Rewrite (codemod), Pattern Language, Language Resolution, Preview/Apply Contract, Known Limits |
