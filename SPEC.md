...
tsift memory import-claude-mem . --apply --limit 1000 --json # migrate supported claude-mem rows into tsift-memory; pending_messages is reported but intentionally excluded
